...
try:
    ...
    with open("b.txt", "w+") as f:
        f.write(b)
    print("Remix my scratch project and copy and paste c.txt to the c variable, b.txt to the b variable and s.txt to the s variable. Don't forget to thank me")
except:
